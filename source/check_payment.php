...
<head>
<meta charset="utf-8">
<title>Check payment - <?php echo $web['title']; ?></title>
    ...
    if ($payment_status == 'Completed') {
        ...
        if ($receiver_email==$web['paypal_email']) {
            ...
            if ($payment_currency == $web['currency']) {
                ...
                $email_code=substr($random_password, 0, 12) . '-' . $_SERVER[REQUEST_URI];
			...
			<table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width:470px;\">
				<tbody>
					<tr>
						...
						<p style=\"color:#393d4b;margin-bottom:10px;\">Let your friends know about your awesome purchase!</p>
