            ...
            <div id="product-basic" class="product-tab">
                ...
                <div class="ui grid form full-width product-upload-form-wrap  editing">
                    <div class="row">
                        ...
                        <div class="column wide sixteen">
                            <div class="field">
								<input type="text" placeholder="Product name (required)" class="input-block-level" name="name">
                            </div>
                            <div class="field">
								<textarea placeholder="Description (required)" class="input-block-level" rows="5" name="description1"></textarea>
								<script>
									CKEDITOR.replace( 'description1' );
								</script>
                            </div>
							<div class="field">
                                <input type="text" placeholder="YouTube video ID (e.g: Lg-WPNpBhp4)" name="video_url" class="input-block-level">
                            </div>
							<div class="field">
                                <input type="text" placeholder="Demo URL (optional)" name="demo_url" class="input-block-level">
                            </div>
							<hr>
							<span>&nbsp;</span>
                                ...
                                <div class="row equal height two column fields">
                                    <div class="column product-upload-price-field">
                                        <div class="ui input join">
                                            ...
                                            <input class="join" id="appendedPrependedInput" placeholder="2.00" name="price_regular" type="text">
                                        </div>
                                    </div>
                                    <div class="column product-upload-price-field">
                                        <div class="ui input join">
                                            ...
                                            <input class="join" id="appendedPrependedInput" placeholder="1.00" name="price_extended" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="setting-button-holder  editing">
          <div class="ui grid">
            <div class="row equal height">
              ...
              <div class="column wide eight aligned center centered">
                  <input type="submit" name="phps_upload" value="Create product" class="ui button red submit_product ">
              </div>
            </div>
          </div>
        </div>
        <input type="hidden" name="discount" value="">
        <input type="hidden" id="file" value="548dd64a81069b7f385af19e" name="file">
