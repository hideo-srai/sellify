...
<div id="left_menu">
    <div class="ui vertical fluid menu">
		...
		<a href="<?php echo $web['url']; ?>admin/payments" data-pushstate="true" class="red item active" id="menu_location_settings">
            Payment Settings
        </a>
    ...
    <form class="ui form payment-options" action="" method="POST">
        <div class="userpage_content">
            <div class="ui grid billing-form">
				<div class="row payment-option-select">
					...
					<div class="column wide twelve">
                        ...
                        <input type="text" value="<?php echo $web['paypal_email']; ?>" name="paypal_email" class="valid">
                        <p align="justify" class="payment-description">
                            All payments will be sent instantly to this PayPal account.
                            Please make sure your PayPal account has been verified or you have not made spelling errors.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="setting-button-holder">
            <div class="submit-container">
                <button type="submit" name="phps_save" class="ui button red">Save changes</button>
            </div>
        </div>
    </form>
</div>
