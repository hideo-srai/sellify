...
<div class="download-page">
  <div class="ui segment download-page-content" id="productland_content">
    <div class="stackable ui grid">
      <div class="row product-header">
        <div class="column aligned center">
          <h1 class="ui header normal">Thank you for your purchase!</h1>
        </div>
      </div>
      
        <div class="row">
        <div class="column">
          <h2 class="ui header normal aligned center">
		  
			Download your product now
            
          </h2>
          
            <div class="ui divider horizontal">GO</div>
...
<div class="auth">
    <div class="ui form ">
        ...
        <div class="field">
            <label for="merchant_reg_name">Product name</label>
            <input type="text" value="<?php echo $row['name']; ?>" tabindex="1" placeholder="<?php echo $row['name']; ?>" name="hurighi" autofocus="autofocus" disabled>
        </div>
	  <form action="" method="POST">
        <div class="field">
            <label>Email address</label>
            <input type="text" id="inputUsername" name="email" placeholder="download@example.com">            
        </div>
        <div class="field">
            <label>Code (under DOWNLOAD button in email)</label>
            <input id="inputUsername" type="text" autocomplete="off" placeholder="e.g: b8adb1139288" value="" name="code" tabindex="3">
        </div>
        <div class="field button_submit_wrap">
            <button id="signup_submit" name="do_download" class="ui red submit button" type="submit" tabindex="8" >
            Download
            </button>
        </div>
    </div>
      ...
      <div class="row">
        <div class="column download_page_side center aligned">
          
          <div  class="ui labeled icon button no-mobile download-instantly" id="download_button_open">
            <i class="dropbox icon"><i class="fa fa-info-circle"></i></i>
            <span class="button-normal">Follow download instructions</span>
          </div>
          
          <div id="download_button_holder" class="only-mobile hidden">
            <!--<div class="download-button-wrap">
            <p align="center">You have unlimited download attempts left for this product!</p>
            </div>-->
            <div id="file_info" class="download-meta-details">
              
                Email address: The same email address that was used to make your payment.
                <div>Please find your download code under download button on our email purchasing notification!</div>
    ...
    <input type="hidden" value="1Xxh" id="product_key">
    <i class="icon close close-iframe"></i>
  </div>
  <div id="iframe_overlay_ghost" class="close-iframe"></div>
</div>
