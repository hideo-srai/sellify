...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Delete product - <?php echo $web['title']; ?></title>
      ...
      <div class="static-page-container">
		<div class="ui segment white">
			...
			if($_GET['confirmed'] == "yes") {
				...
				echo '</div>';
				echo '<center><a href="'.$web[url].'dashboard" class="ui button red">Return to dashboard</a></center>';
			} else {
				echo '<div class="alert color orange-color">';
				echo '<p align="center">Are you sure you want to delete this product ('.($row[name]).')?</p>';
				echo '</div>';
				echo '<center><a href="'.$web[url].'confirm_delete/'.$row[id].'" class="ui button small green">Yes</a>&nbsp;&nbsp;<a href="'.$web[url].'dashboard/" class="ui button small red">No</a></center>';
			}
			?>
			</div>
		</div>
...
<footer id="footer" id="footer" class="site-footer">
