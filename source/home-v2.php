...
<?php } ?>
  ...
  <div class="ui grid full-width content marketplace-category">
    <div class="row two column equal height header-wrap">
        <h2 class="ui header">
          <center>
	...
	<?php
						...
						$get = mysql_fetch_array(mysql_query("SELECT * FROM categories WHERE id='$row[category_id]'"));
						?>

          <div class="ui segment item product-item ">
    
      
    
    <div class="ui image product-image">
      
        <a class="product-image-static" title="<?php echo $row['name']; ?>" href="<?php echo $web['url']; ?>p/<?php echo $row['id']; ?>"
           style="background-image: url('<?php echo $web['url']; echo $row['preview']; ?>')" target="_top"></a>
    ...
    <div class="ui grid">
      <div class="row product-meta-info">
        <div class="column wide sixteen">
          ...
          <h3 class="ui header">
            <a class="truncate" title="<?php echo $row['name']; ?>" href="<?php echo $web['url']; ?>p/<?php echo $row['id']; ?>" target="_top" itemprop="name">
              <?php echo $row['name']; ?>
            </a>
          </h3>
      ...
      <div class="row equal height two column product-price-wrap">
        <div class="column aligned left">
          <a class="price" title="<?php echo $row['name']; ?>" href="<?php echo $web['url']; ?>p/<?php echo $row['id']; ?>" target="_top">
            
            <span class="">
              <?php echo $row['price_extended']; echo decode_currency($web['currency']); ?>
            </span>
          </a>
        </div>
        <div class="column aligned right">
            <a class="ui button small red" title="Buy <?php echo $row['name']; ?>" href="<?php echo $web['url']; ?>p/<?php echo $row['id']; ?>" target="_top">
              Buy now
            </a>
        </div>
      </div>
