...
<section class="page-section">
  <div class="grid-container h-text-align-center">
    <header>
      <h1 class="t-heading -size-xxl">Our Items</h1>
      <h2 class="t-body -size-xl">See what we have to offer.</h2>
    </header>
	<?php
  ...
  <?php if($row['price_extended'] == 0.00) { ?><div class="ui label clip red">FREE</div><?php } ?>
  <?php if($row['price_extended'] > 0.00) { ?><div class="ui label clip green"><?php if($web['currency'] == 'USD') { ?><?php echo decode_currency($web['currency']); echo $row['price_extended']; ?><?php } ?><?php if($web['currency'] == 'EUR') { ?><?php echo $row['price_extended']; echo decode_currency($web['currency']); ?><?php } ?></div><?php } ?>
	<a title="<?php echo $row['name']; ?>" href="<?php echo $web['url']; ?>p/<?php echo $row['id']; ?>">
		<img width="314" height="197" alt="" src="<?php echo $web['url']; echo $row['preview']; ?>" />
	</a>
	...
	<?php if($row['price_extended'] > 0.00) { ?><div class="element-corner--triangle -position-left -size-large -color-audiojungle"><?php } ?><?php if($row['price_extended'] == 0.00) { ?><div class="element-corner--triangle -position-left -size-large -color-themeforest"><?php } ?>
		<?php if($row['price_extended'] > 0.00) { ?><?php } ?>
	</div>
  </article>
