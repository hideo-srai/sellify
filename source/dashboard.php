    ...
    <div id="dashboard_header">
        <div class="ui grid stackable">
                ...
                <div class="column wide">
					...
					<br><div class="alert color blue">
							<p align="center">This is <strong>our official wall</strong> for announcements about <strong>sellify</strong>.</p>
					</div>
					<iframe width="100%" height="" src="http://static.nidigo.com/sellify/news.html" name="preview-frame" frameborder="0" noresize="noresize"></iframe>
                </div>
        </div>
    </div>
</div>
