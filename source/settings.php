...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>System Settings - <?php echo $web['title']; ?></title>
...
<?php
			if(isset($_POST['phps_save'])) {
				...
				if(empty($title) or empty($description) or empty($keywords) or empty($sitename) or empty($url) or empty($email)) { echo '<div class="alert color red-color"><p align="center">Fields with * are required.</p></div>'; }
				...
				elseif(!isValidEmail($email)) { echo '<div class="alert color red-color"><p align="center">Please enter valid site email address.</p></div>'; }
					...
					$update = mysql_query("UPDATE sellify_settings SET title='$title',description='$description',keywords='$keywords',sitename='$sitename',url='$url',email='$email'");
...
<div id="left_menu">
    <div class="ui vertical fluid menu">
		...
		<a href="<?php echo $web['url']; ?>admin/settings" data-pushstate="true" class="red item active" id="menu_account">
            System Settings
        </a>
    ...
    <div class="head-description">
        ...
        <p>Your system information and store settings.</p>
    ...
    <form class="ui form payment-options" action="" method="POST">
        <div class="userpage_content">
            <div class="ui grid billing-form">
                <input type="hidden" name="image">
                <div class="settings-logo-upload"></div>
                <div class="ui grid">
					<div class="row">
                        <div class="column field">
                            <label class="control-label">* Store email</label>
                            <input type="text" name="email" value="<?php echo $web['email']; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="column field">
                    ...
                    <div class="row">
                        <div class="column field">
                            <label class="control-label">* Description (Maximum 160 characters)</label>
                            <textarea name="description" maxlength="160" rows="1"><?php echo $web['description']; ?></textarea>
                        </div>
                    </div>
					<div class="row">
                        <div class="column field">
                            <label class="control-label">* Keywords (separated by comma)</label>
                            <textarea name="keywords" maxlength="320" rows="1"><?php echo $web['keywords']; ?></textarea>
                        </div>
                    </div>
					<div class="row">
                        <div class="column field">
                            <label class="control-label">* Site name</label>
                            <input type="text" name="sitename" value="<?php echo $web['sitename']; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="column field">
                            <label class="control-label">* Site url (with ending slash)</label>
                            <input type="text" name="url" value="<?php echo $web['url']; ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ui grid">
                <div class="row">
                    <div class="column wide sixteen">
                        <center><input class="ui button red" type="submit" value="Save settings" name="phps_save"></center>
                    </div>
                </div>
            </div>
            <div class="ui dimmer inverted save-dimmer">
